# ─────────────────────────────────────────────
# Green Life — Icon Fix Script (Windows PowerShell)
# Run from root of your Green Life project:
#   PowerShell -ExecutionPolicy Bypass -File .\fix-icons.ps1
# ─────────────────────────────────────────────

Write-Host ""
Write-Host "Green Life - Fixing icons..." -ForegroundColor Green
Write-Host ""
          ...
          options={{
            ...
            tabBarIcon: () => (
              <View style={styles.scanBtn}>
                <Ionicons name="scan-outline" size={24} color="#F5F3EF" />
              </View>
            ),
          }}
        />
...
Write-Host "navigation/AppNavigator.tsx updated" -ForegroundColor Cyan
...
Write-Host "screens/HomeScreen.tsx updated" -ForegroundColor Cyan
...
Write-Host "screens/SearchScreen.tsx updated" -ForegroundColor Cyan

Write-Host ""
Write-Host "All icons fixed. Now run:" -ForegroundColor Green
