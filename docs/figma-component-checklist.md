# Green Life Figma Component Checklist

## Foundations

- [ ] Create page `00 Cover`
- [ ] Create page `01 Foundations`
- [ ] Add color styles for `Green`, `Sand`, `Slate`, `Alert`, and `Info`
- [ ] Add typography styles for `Display`, `Heading`, `Title`, `Body`, `Label`, `Caption`
- [ ] Add spacing reference using 8pt system
- [ ] Add radius and elevation references
...
- [ ] Every screen uses component instances where possible
- [ ] Exact vs estimated states are visibly distinct
- [ ] Source provenance is visible on result and detail screens
- [ ] Loading, empty, and error states exist for Search, Saved, and Item Detail
- [ ] Screen names match React Native screen filenames
